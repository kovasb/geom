...
thi.ng.geom.core.quaternion.Quat4.cljs$lang$ctorPrWriter = (function (this__4048__auto__,writer__4049__auto__,opt__4050__auto__){return cljs.core._write.call(null,writer__4049__auto__,"thi.ng.geom.core.quaternion/Quat4");
});
thi.ng.geom.core.quaternion.Quat4.prototype.thi$ng$geom$core$PVectorTransform$ = true;
thi.ng.geom.core.quaternion.Quat4.prototype.thi$ng$geom$core$PVectorTransform$transform_vector$arity$2 = (function (_,p__8237){var self__ = this;
var vec__8238 = p__8237;var vx = cljs.core.nth.call(null,vec__8238,0,null);var vy = cljs.core.nth.call(null,vec__8238,1,null);var vz = cljs.core.nth.call(null,vec__8238,2,null);var v = vec__8238;var ___$1 = this;var ix = (((self__.w * vx) + (self__.y * vz)) - (self__.z * vy));var iy = (((self__.w * vy) + (self__.z * vx)) - (self__.x * vz));var iz = (((self__.w * vz) + (self__.x * vy)) - (self__.y * vx));var nx = (- self__.x);var ny = (- self__.y);var nz = (- self__.z);var iw = (((nx * vx) - (self__.y * vy)) - (self__.z * vz));return (new thi.ng.geom.core.vector.Vec3(((((ix * self__.w) + (iw * nx)) + (iy * nz)) - (iz * ny)),((((iy * self__.w) + (iw * ny)) + (iz * nx)) - (ix * nz)),((((iz * self__.w) + (iw * nz)) + (ix * ny)) - (iy * nx))));
});
...
var ___$1 = this;var G__8239 = (k | 0);if(cljs.core._EQ_.call(null,3,G__8239))
{return self__.w;
} else
...
var ___$1 = this;var G__8240 = (k | 0);if(cljs.core._EQ_.call(null,3,G__8240))
{return self__.w;
} else
...
var ___$1 = this;var G__8241 = (k | 0);if(cljs.core._EQ_.call(null,3,G__8241))
...
var ___$1 = this;var vec__8243 = new cljs.core.Keyword(null,"translate","translate",2066736320).cljs$core$IFn$_invoke$arity$1(opts);var tx = cljs.core.nth.call(null,vec__8243,0,null);var ty = cljs.core.nth.call(null,vec__8243,1,null);var tz = cljs.core.nth.call(null,vec__8243,2,null);var x2 = (self__.x + self__.x);var y2 = (self__.y + self__.y);var z2 = (self__.z + self__.z);var xx = (self__.x * x2);var xy = (self__.x * y2);var xz = (self__.x * z2);var yy = (self__.y * y2);var yz = (self__.y * z2);var zz = (self__.z * z2);var wx = (self__.w * x2);var wy = (self__.w * y2);var wz = (self__.w * z2);return (new thi.ng.geom.core.matrix.Matrix44((1.0 - (yy + zz)),(xy + wz),(xz - wy),0.0,(xy - wz),(1.0 - (xx + zz)),(yz + wx),0.0,(xz + wy),(yz - wx),(1.0 - (xx + yy)),0.0,(function (){var or__3481__auto__ = tx;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return 0.0;
}
})(),(function (){var or__3481__auto__ = ty;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return 0.0;
}
})(),(function (){var or__3481__auto__ = tz;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return 0.0;
}
...
var G__8244__3 = (function (self__,k,nf){var self__ = this;
...
;
thi.ng.geom.core.quaternion.Quat4.prototype.apply = (function (self__,args8236){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args8236)));
});
...
var quat__1 = (function (p__8246){var vec__8250 = p__8246;var x = cljs.core.nth.call(null,vec__8250,0,null);var y = cljs.core.nth.call(null,vec__8250,1,null);var z = cljs.core.nth.call(null,vec__8250,2,null);var w = cljs.core.nth.call(null,vec__8250,3,null);return (new thi.ng.geom.core.quaternion.Quat4(x,y,z,w));
});
var quat__2 = (function (p__8245,w){var vec__8249 = p__8245;var x = cljs.core.nth.call(null,vec__8249,0,null);var y = cljs.core.nth.call(null,vec__8249,1,null);var z = cljs.core.nth.call(null,vec__8249,2,null);return (new thi.ng.geom.core.quaternion.Quat4(x,y,z,w));
});
...
var quat_from_euler__delegate = function (order,p__8251){var vec__8255 = p__8251;var alpha = cljs.core.nth.call(null,vec__8255,0,null);var beta = cljs.core.nth.call(null,vec__8255,1,null);var gamma = cljs.core.nth.call(null,vec__8255,2,null);var vec__8256 = (function (){var G__8257 = order;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"zyx","zyx",1014025355),G__8257))
...
})();var a = cljs.core.nth.call(null,vec__8256,0,null);var b = cljs.core.nth.call(null,vec__8256,1,null);var c = cljs.core.nth.call(null,vec__8256,2,null);return thi.ng.geom.core._STAR_.call(null,thi.ng.geom.core.quaternion.quat_from_axis_angle.call(null,a,alpha),thi.ng.geom.core.quaternion.quat_from_axis_angle.call(null,b,beta),thi.ng.geom.core.quaternion.quat_from_axis_angle.call(null,c,gamma));
};
...
thi.ng.geom.core.quaternion.lookup4 = (function lookup4(_,k,nf){var G__8260 = k;if(cljs.core._EQ_.call(null,"w",G__8260))
{return _.w;
} else
...
{var G__8264 = (k | 0);if(cljs.core._EQ_.call(null,3,G__8264))
{return _.w;
} else
...
{var G__8265 = k;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"w","w",1013904361),G__8265))
{return _.w;
} else
...
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var n = cljs.core.name.call(null,k);var c = cljs.core.count.call(null,n);var G__8266 = c;if(cljs.core._EQ_.call(null,4,G__8266))
...
{var G__8269 = (k | 0);if(cljs.core._EQ_.call(null,3,G__8269))
...
{var G__8270 = k;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"w","w",1013904361),G__8270))
{return (new thi.ng.geom.core.quaternion.Quat4(_.x,_.y,_.z,v));
} else
