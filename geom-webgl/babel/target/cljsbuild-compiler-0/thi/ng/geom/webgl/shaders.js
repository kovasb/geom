...
thi.ng.geom.webgl.shaders.init_shader_uniforms = (function init_shader_uniforms(gl,prog,uniforms){return cljs.core.reduce.call(null,(function (umap,p__6136){var vec__6137 = p__6136;var id = cljs.core.nth.call(null,vec__6137,0,null);var type = cljs.core.nth.call(null,vec__6137,1,null);var loc = gl.getUniformLocation(prog,cljs.core.name.call(null,id));var vec__6138 = ((cljs.core.sequential_QMARK_.call(null,type))?type:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [type], null));var type__$1 = cljs.core.nth.call(null,vec__6138,0,null);var transpose_QMARK_ = cljs.core.nth.call(null,vec__6138,1,null);var transpose_QMARK___$1 = cljs.core.boolean$.call(null,transpose_QMARK_);var vec__6139 = thi.ng.geom.webgl.shaders.uniform_types.call(null,type__$1);var u_type = cljs.core.nth.call(null,vec__6139,0,null);var u_cast = cljs.core.nth.call(null,vec__6139,1,null);var setter = (gl[[cljs.core.str("uniform"),cljs.core.str(u_type)].join('')]);return cljs.core.assoc.call(null,umap,id,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1017479852),type__$1,new cljs.core.Keyword(null,"setter","setter",4403102705),(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"mat3","mat3",1017248325),null,new cljs.core.Keyword(null,"mat2","mat2",1017248324),null,new cljs.core.Keyword(null,"mat4","mat4",1017248326),null], null), null).call(null,type__$1))?((function (loc,vec__6138,type__$1,transpose_QMARK_,transpose_QMARK___$1,vec__6139,u_type,u_cast,setter,vec__6137,id,type){
...
});})(loc,vec__6138,type__$1,transpose_QMARK_,transpose_QMARK___$1,vec__6139,u_type,u_cast,setter,vec__6137,id,type))
:((function (loc,vec__6138,type__$1,transpose_QMARK_,transpose_QMARK___$1,vec__6139,u_type,u_cast,setter,vec__6137,id,type){
...
thi.ng.geom.webgl.shaders.set_attribute = (function set_attribute(gl,shader,id,p__6140){var map__6143 = p__6140;var map__6143__$1 = ((cljs.core.seq_QMARK_.call(null,map__6143))?cljs.core.apply.call(null,cljs.core.hash_map,map__6143):map__6143);var offset = cljs.core.get.call(null,map__6143__$1,new cljs.core.Keyword(null,"offset","offset",4289091589));var normalized_QMARK_ = cljs.core.get.call(null,map__6143__$1,new cljs.core.Keyword(null,"normalized?","normalized?",762171290));var type = cljs.core.get.call(null,map__6143__$1,new cljs.core.Keyword(null,"type","type",1017479852));var size = cljs.core.get.call(null,map__6143__$1,new cljs.core.Keyword(null,"size","size",1017434995));var stride = cljs.core.get.call(null,map__6143__$1,new cljs.core.Keyword(null,"stride","stride",4416885323));var buffer = cljs.core.get.call(null,map__6143__$1,new cljs.core.Keyword(null,"buffer","buffer",3930752946));var temp__4124__auto__ = cljs.core.get_in.call(null,shader,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attribs","attribs",4634025563),id], null));if(cljs.core.truth_(temp__4124__auto__))
{var loc = temp__4124__auto__;var G__6144 = gl;G__6144.bindBuffer(thi.ng.geom.webgl.core.array_buffer,buffer);
G__6144.enableVertexAttribArray(loc);
G__6144.vertexAttribPointer(loc,size,(function (){var or__3481__auto__ = type;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return thi.ng.geom.webgl.core.float$;
}
})(),cljs.core.boolean$.call(null,normalized_QMARK_),(function (){var or__3481__auto__ = stride;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return 0;
}
})(),(function (){var or__3481__auto__ = offset;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return 0;
}
...
thi.ng.geom.webgl.shaders.compile_glsl_vars = (function compile_glsl_vars(qualifier,coll){return cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (p__6147){var vec__6148 = p__6147;var id = cljs.core.nth.call(null,vec__6148,0,null);var type = cljs.core.nth.call(null,vec__6148,1,null);return [cljs.core.str(qualifier),cljs.core.str(" "),cljs.core.str(cljs.core.name.call(null,type)),cljs.core.str(" "),cljs.core.str(cljs.core.name.call(null,id)),cljs.core.str(";\n")].join('');
}),coll));
});
...
return (function (line){var vec__6150 = cljs.core.re_find.call(null,/ERROR: \d+:(\d+): (.*)/,line);var _ = cljs.core.nth.call(null,vec__6150,0,null);var ln = cljs.core.nth.call(null,vec__6150,1,null);var msg = cljs.core.nth.call(null,vec__6150,2,null);if(cljs.core.truth_(ln))
...
thi.ng.geom.webgl.shaders.make_shader_from_spec = (function make_shader_from_spec(gl,p__6151){var map__6155 = p__6151;var map__6155__$1 = ((cljs.core.seq_QMARK_.call(null,map__6155))?cljs.core.apply.call(null,cljs.core.hash_map,map__6155):map__6155);var prefix = cljs.core.get.call(null,map__6155__$1,new cljs.core.Keyword(null,"prefix","prefix",4328760836));var varying = cljs.core.get.call(null,map__6155__$1,new cljs.core.Keyword(null,"varying","varying",1251174370));var attribs = cljs.core.get.call(null,map__6155__$1,new cljs.core.Keyword(null,"attribs","attribs",4634025563));var uniforms = cljs.core.get.call(null,map__6155__$1,new cljs.core.Keyword(null,"uniforms","uniforms",709120177));var fs = cljs.core.get.call(null,map__6155__$1,new cljs.core.Keyword(null,"fs","fs",1013907519));var vs = cljs.core.get.call(null,map__6155__$1,new cljs.core.Keyword(null,"vs","vs",1013908015));var u_src = thi.ng.geom.webgl.shaders.compile_glsl_vars.call(null,"uniform",uniforms);var a_src = thi.ng.geom.webgl.shaders.compile_glsl_vars.call(null,"attribute",attribs);var v_src = thi.ng.geom.webgl.shaders.compile_glsl_vars.call(null,"varying",varying);var prefix__$1 = [cljs.core.str((function (){var or__3481__auto__ = prefix;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return thi.ng.geom.webgl.shaders.header_prefix;
}
})()),cljs.core.str(u_src),cljs.core.str(v_src)].join('');var vs__$1 = thi.ng.geom.webgl.shaders.compile_shader.call(null,gl,[cljs.core.str(prefix__$1),cljs.core.str(a_src),cljs.core.str(vs)].join(''),thi.ng.geom.webgl.core.vertex_shader);var fs__$1 = thi.ng.geom.webgl.shaders.compile_shader.call(null,gl,[cljs.core.str(prefix__$1),cljs.core.str(fs)].join(''),thi.ng.geom.webgl.core.fragment_shader);var prog = gl.createProgram();var G__6156_6158 = gl;G__6156_6158.attachShader(prog,vs__$1);
...
{var uniforms__$1 = thi.ng.geom.webgl.shaders.init_shader_uniforms.call(null,gl,prog,uniforms);var attribs__$1 = thi.ng.geom.webgl.shaders.init_shader_attribs.call(null,gl,prog,cljs.core.keys.call(null,attribs));var G__6157_6159 = gl;G__6157_6159.deleteShader(vs__$1);
...
thi.ng.geom.webgl.shaders.make_shader_from_dom = (function make_shader_from_dom(gl,p__6160){var map__6162 = p__6160;var map__6162__$1 = ((cljs.core.seq_QMARK_.call(null,map__6162))?cljs.core.apply.call(null,cljs.core.hash_map,map__6162):map__6162);var spec = map__6162__$1;var fs = cljs.core.get.call(null,map__6162__$1,new cljs.core.Keyword(null,"fs","fs",1013907519));var vs = cljs.core.get.call(null,map__6162__$1,new cljs.core.Keyword(null,"vs","vs",1013908015));return thi.ng.geom.webgl.shaders.make_shader_from_spec.call(null,gl,cljs.core.assoc.call(null,spec,new cljs.core.Keyword(null,"vs","vs",1013908015),thi.ng.geom.webgl.utils.get_script_text.call(null,vs),new cljs.core.Keyword(null,"fs","fs",1013907519),thi.ng.geom.webgl.utils.get_script_text.call(null,fs)));
});
