...
var plane_from_points__1 = (function (p__8226){var vec__8228 = p__8226;var a = cljs.core.nth.call(null,vec__8228,0,null);var b = cljs.core.nth.call(null,vec__8228,1,null);var c = cljs.core.nth.call(null,vec__8228,2,null);return plane_from_points.call(null,a,b,c);
});
...
thi.ng.geom.types.Plane.prototype.thi$ng$geom$core$PIntersect$intersect_line$arity$2 = (function (_,p__8230){var map__8231 = p__8230;var map__8231__$1 = ((cljs.core.seq_QMARK_.call(null,map__8231))?cljs.core.apply.call(null,cljs.core.hash_map,map__8231):map__8231);var vec__8232 = cljs.core.get.call(null,map__8231__$1,new cljs.core.Keyword(null,"points","points",4326117461));var p = cljs.core.nth.call(null,vec__8232,0,null);var q = cljs.core.nth.call(null,vec__8232,1,null);var ___$1 = this;return thi.ng.geom.core.intersect.intersect_ray_plane_QMARK_.call(null,p,thi.ng.geom.core._.call(null,q,p),new cljs.core.Keyword(null,"n","n",1013904352).cljs$core$IFn$_invoke$arity$1(___$1),new cljs.core.Keyword(null,"w","w",1013904361).cljs$core$IFn$_invoke$arity$1(___$1));
});
...
thi.ng.geom.types.Plane.prototype.thi$ng$geom$core$PMeshConvert$as_mesh$arity$2 = (function (_,p__8233){var map__8234 = p__8233;var map__8234__$1 = ((cljs.core.seq_QMARK_.call(null,map__8234))?cljs.core.apply.call(null,cljs.core.hash_map,map__8234):map__8234);var mesh = cljs.core.get.call(null,map__8234__$1,new cljs.core.Keyword(null,"mesh","mesh",1017252191));var size = cljs.core.get.call(null,map__8234__$1,new cljs.core.Keyword(null,"size","size",1017434995),1.0);var height = cljs.core.get.call(null,map__8234__$1,new cljs.core.Keyword(null,"height","height",4087841945));var width = cljs.core.get.call(null,map__8234__$1,new cljs.core.Keyword(null,"width","width",1127031096));var p = cljs.core.get.call(null,map__8234__$1,new cljs.core.Keyword(null,"p","p",1013904354));var ___$1 = this;var w = ((function (){var or__3481__auto__ = width;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return size;
}
})() * 0.5);var h = ((function (){var or__3481__auto__ = height;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return size;
}
})() * 0.5);var flip_QMARK_ = thi.ng.common.math.core.delta_EQ_.call(null,-1.0,thi.ng.geom.core.dot.call(null,new cljs.core.Keyword(null,"n","n",1013904352).cljs$core$IFn$_invoke$arity$1(___$1),thi.ng.geom.core.vector.V3Z));var p__$1 = thi.ng.geom.core.closest_point.call(null,___$1,(function (){var or__3481__auto__ = p;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
{return thi.ng.geom.core.vector.vec3.call(null);
}
})());var q = ((flip_QMARK_)?thi.ng.geom.core.quaternion.quat.call(null,0,0,0,1):thi.ng.geom.core.quaternion.alignment_quat.call(null,thi.ng.geom.core.vector.V3Z,new cljs.core.Keyword(null,"n","n",1013904352).cljs$core$IFn$_invoke$arity$1(___$1)));var vec__8235 = cljs.core.map.call(null,((function (w,h,flip_QMARK_,p__$1,q,___$1,map__8234,map__8234__$1,mesh,size,height,width,p){
return (function (p1__8229_SHARP_){return thi.ng.geom.core._PLUS_.call(null,p__$1,thi.ng.geom.core.transform_vector.call(null,q,p1__8229_SHARP_));
});})(w,h,flip_QMARK_,p__$1,q,___$1,map__8234,map__8234__$1,mesh,size,height,width,p))
,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [thi.ng.geom.core.vector.vec3.call(null,(- w),(- h),0),thi.ng.geom.core.vector.vec3.call(null,(- w),h,0),thi.ng.geom.core.vector.vec3.call(null,w,h,0),thi.ng.geom.core.vector.vec3.call(null,w,(- h),0)], null));var a = cljs.core.nth.call(null,vec__8235,0,null);var b = cljs.core.nth.call(null,vec__8235,1,null);var c = cljs.core.nth.call(null,vec__8235,2,null);var d = cljs.core.nth.call(null,vec__8235,3,null);return thi.ng.geom.gmesh.add_face.call(null,(function (){var or__3481__auto__ = mesh;if(cljs.core.truth_(or__3481__auto__))
{return or__3481__auto__;
} else
