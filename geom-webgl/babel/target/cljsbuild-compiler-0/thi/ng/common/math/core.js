...
var delta_EQ___3 = (function (a,b,delta){if(cljs.core.truth_((function (){var and__3469__auto__ = a;if(cljs.core.truth_(and__3469__auto__))
{return b;
} else
...
{return (cljs.core._EQ_.call(null,cljs.core.count.call(null,a),cljs.core.count.call(null,b))) && (cljs.core.every_QMARK_.call(null,cljs.core.true_QMARK_,cljs.core.map.call(null,(function (p1__8307_SHARP_,p2__8308_SHARP_){return (thi.ng.common.math.core.abs.call(null,(p1__8307_SHARP_ - p2__8308_SHARP_)) <= delta);
}),a,b)));
}
} else
...
var map_interval__3 = (function (x,p__8309,p__8310){var vec__8313 = p__8309;var minIn = cljs.core.nth.call(null,vec__8313,0,null);var maxIn = cljs.core.nth.call(null,vec__8313,1,null);var vec__8314 = p__8310;var minOut = cljs.core.nth.call(null,vec__8314,0,null);var maxOut = cljs.core.nth.call(null,vec__8314,1,null);return (((maxOut - minOut) * ((x - minIn) / (maxIn - minIn))) + minOut);
});
...
var in_range_QMARK___2 = (function (p__8315,x){var vec__8317 = p__8315;var min = cljs.core.nth.call(null,vec__8317,0,null);var max = cljs.core.nth.call(null,vec__8317,1,null);return ((x >= min)) && ((x <= max));
});
...
* resolution 1/x.
*/
thi.ng.common.math.core.norm_range = (function norm_range(x){return cljs.core.map.call(null,(function (p1__8318_SHARP_){return (p1__8318_SHARP_ / x);
...
*/
thi.ng.common.math.core.quartile = (function quartile(n,sorted){var vec__8321 = thi.ng.common.math.core.quartile_range.call(null,n,cljs.core.count.call(null,sorted));var a = cljs.core.nth.call(null,vec__8321,0,null);var b = cljs.core.nth.call(null,vec__8321,1,null);return cljs.core.take.call(null,(b - a),cljs.core.drop.call(null,a,sorted));
});
...
return (function (p1__8322_SHARP_){return (s * p1__8322_SHARP_);
});})(ws,s))
,ws);
});
