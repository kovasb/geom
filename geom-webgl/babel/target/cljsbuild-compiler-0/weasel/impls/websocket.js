...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj6383 = {};return obj6383;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__3469__auto__ = this$;if(and__3469__auto__)
...
{var x__4108__auto__ = (((this$ == null))?null:this$);return (function (){var or__3481__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__4108__auto__)]);if(or__3481__auto__)
{return or__3481__auto__;
} else
{var or__3481__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__3481__auto____$1)
...
return (function (p__6384){var vec__6385 = p__6384;var k = cljs.core.nth.call(null,vec__6385,0,null);var v = cljs.core.nth.call(null,vec__6385,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
