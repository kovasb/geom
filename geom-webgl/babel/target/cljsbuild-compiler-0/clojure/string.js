...
{var pred__8179 = cljs.core._EQ_;var expr__8180 = limit;if(cljs.core.truth_(pred__8179.call(null,1,expr__8180)))
...
{var ch = s.charAt(index);var temp__4124__auto___8186 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___8186))
{var replacement_8187 = temp__4124__auto___8186;buffer.append([cljs.core.str(replacement_8187)].join(''));
} else
{buffer.append(ch);
}
{
