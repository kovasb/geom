...
return (function (p1__7902_SHARP_){return (max === p1__7902_SHARP_);
});})(max))
,coll));
});
/**
...
var G__7903__delegate = function (s1,s2,sets){var bubbled_sets = clojure.set.bubble_max_key.call(null,cljs.core.count,cljs.core.conj.call(null,sets,s2,s1));return cljs.core.reduce.call(null,cljs.core.into,cljs.core.first.call(null,bubbled_sets),cljs.core.rest.call(null,bubbled_sets));
};
...
var G__7908__delegate = function (s1,s2,sets){var bubbled_sets = clojure.set.bubble_max_key.call(null,(function (p1__7905_SHARP_){return (- cljs.core.count.call(null,p1__7905_SHARP_));
...
var G__7910__delegate = function (s1,s2,sets){return cljs.core.reduce.call(null,difference,s1,cljs.core.conj.call(null,sets,s2));
};
...
*/
clojure.set.project = (function project(xrel,ks){return cljs.core.set.call(null,cljs.core.map.call(null,(function (p1__7912_SHARP_){return cljs.core.select_keys.call(null,p1__7912_SHARP_,ks);
}),xrel));
});
/**
* Returns the map with the keys in kmap renamed to the vals in kmap
*/
clojure.set.rename_keys = (function rename_keys(map,kmap){return cljs.core.reduce.call(null,(function (m,p__7915){var vec__7916 = p__7915;var old = cljs.core.nth.call(null,vec__7916,0,null);var new$ = cljs.core.nth.call(null,vec__7916,1,null);if((cljs.core.not_EQ_.call(null,old,new$)) && (cljs.core.contains_QMARK_.call(null,m,old)))
...
*/
clojure.set.rename = (function rename(xrel,kmap){return cljs.core.set.call(null,cljs.core.map.call(null,(function (p1__7917_SHARP_){return clojure.set.rename_keys.call(null,p1__7917_SHARP_,kmap);
}),xrel));
});
/**
...
*/
clojure.set.map_invert = (function map_invert(m){return cljs.core.reduce.call(null,(function (m__$1,p__7920){var vec__7921 = p__7920;var k = cljs.core.nth.call(null,vec__7921,0,null);var v = cljs.core.nth.call(null,vec__7921,1,null);return cljs.core.assoc.call(null,m__$1,v,k);
...
{var ks = clojure.set.intersection.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,cljs.core.first.call(null,xrel))),cljs.core.set.call(null,cljs.core.keys.call(null,cljs.core.first.call(null,yrel))));var vec__7928 = (((cljs.core.count.call(null,xrel) <= cljs.core.count.call(null,yrel)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [xrel,yrel], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [yrel,xrel], null));var r = cljs.core.nth.call(null,vec__7928,0,null);var s = cljs.core.nth.call(null,vec__7928,1,null);var idx = clojure.set.index.call(null,r,ks);return cljs.core.reduce.call(null,((function (ks,vec__7928,r,s,idx){
...
return (function (p1__7922_SHARP_,p2__7923_SHARP_){return cljs.core.conj.call(null,p1__7922_SHARP_,cljs.core.merge.call(null,p2__7923_SHARP_,x));
});})(found,ks,vec__7928,r,s,idx))
,ret,found);
} else
{return ret;
}
});})(ks,vec__7928,r,s,idx))
,cljs.core.PersistentHashSet.EMPTY,s);
} else
{return cljs.core.PersistentHashSet.EMPTY;
}
});
var join__3 = (function (xrel,yrel,km){var vec__7929 = (((cljs.core.count.call(null,xrel) <= cljs.core.count.call(null,yrel)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [xrel,yrel,clojure.set.map_invert.call(null,km)], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [yrel,xrel,km], null));var r = cljs.core.nth.call(null,vec__7929,0,null);var s = cljs.core.nth.call(null,vec__7929,1,null);var k = cljs.core.nth.call(null,vec__7929,2,null);var idx = clojure.set.index.call(null,r,cljs.core.vals.call(null,k));return cljs.core.reduce.call(null,((function (vec__7929,r,s,k,idx){
...
return (function (p1__7924_SHARP_,p2__7925_SHARP_){return cljs.core.conj.call(null,p1__7924_SHARP_,cljs.core.merge.call(null,p2__7925_SHARP_,x));
});})(found,vec__7929,r,s,k,idx))
,ret,found);
} else
{return ret;
}
...
*/
clojure.set.subset_QMARK_ = (function subset_QMARK_(set1,set2){return ((cljs.core.count.call(null,set1) <= cljs.core.count.call(null,set2))) && (cljs.core.every_QMARK_.call(null,(function (p1__7930_SHARP_){return cljs.core.contains_QMARK_.call(null,set2,p1__7930_SHARP_);
}),set1));
});
/**
* Is set1 a superset of set2?
*/
clojure.set.superset_QMARK_ = (function superset_QMARK_(set1,set2){return ((cljs.core.count.call(null,set1) >= cljs.core.count.call(null,set2))) && (cljs.core.every_QMARK_.call(null,(function (p1__7931_SHARP_){return cljs.core.contains_QMARK_.call(null,set1,p1__7931_SHARP_);
}),set2));
});
