...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj6744 = {};return obj6744;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__5188__auto__ = this$;if(and__5188__auto__)
...
{var x__5827__auto__ = (((this$ == null))?null:this$);return (function (){var or__5200__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__5827__auto__)]);if(or__5200__auto__)
{return or__5200__auto__;
} else
{var or__5200__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__5200__auto____$1)
...
return (function (p__6745){var vec__6746 = p__6745;var k = cljs.core.nth.call(null,vec__6746,0,null);var v = cljs.core.nth.call(null,vec__6746,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
