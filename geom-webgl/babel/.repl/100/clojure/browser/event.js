...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj8475 = {};return obj8475;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__4941__auto__ = this$;if(and__4941__auto__)
...
{var x__5580__auto__ = (((this$ == null))?null:this$);return (function (){var or__4953__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__5580__auto__)]);if(or__4953__auto__)
{return or__4953__auto__;
} else
{var or__4953__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__4953__auto____$1)
...
return (function (p__8476){var vec__8477 = p__8476;var k = cljs.core.nth.call(null,vec__8477,0,null);var v = cljs.core.nth.call(null,vec__8477,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__8478){var vec__8479 = p__8478;var k = cljs.core.nth.call(null,vec__8479,0,null);var v = cljs.core.nth.call(null,vec__8479,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
