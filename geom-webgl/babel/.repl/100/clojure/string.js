...
{{
var G__10429 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10429;
continue;
}
} else
...
{var pred__10433 = cljs.core._EQ_;var expr__10434 = limit;if(cljs.core.truth_(pred__10433.call(null,1,expr__10434)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10433.call(null,2,expr__10434)))
...
var G__10436 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10437 = (limit__$1 - 1);
var G__10438 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10436;
limit__$1 = G__10437;
parts = G__10438;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10440 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10440))
{var replacement_10441 = temp__4124__auto___10440;buffer.append([cljs.core.str(replacement_10441)].join(''));
} else
{buffer.append(ch);
}
{
