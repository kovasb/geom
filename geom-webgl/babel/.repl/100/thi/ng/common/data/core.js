...
{var vec__10129 = temp__4124__auto__;var k__$1 = cljs.core.nth.call(null,vec__10129,0,null);var vv = cljs.core.nth.call(null,vec__10129,1,null);return cljs.core.assoc.call(null,m,k__$1,cljs.core.conj.call(null,vv,v));
} else
...
var value_set__3 = (function (f,idx,v){return cljs.core.persistent_BANG_.call(null,cljs.core.reduce.call(null,(function (p1__10130_SHARP_,p2__10131_SHARP_){return cljs.core.conj_BANG_.call(null,p1__10130_SHARP_,f.call(null,p2__10131_SHARP_));
...
thi.ng.common.data.core.set_conj2_STAR_ = (function set_conj2_STAR_(p1__10132_SHARP_,p2__10133_SHARP_){if((p1__10132_SHARP_ == null))
{return p2__10133_SHARP_;
} else
{if(cljs.core.set_QMARK_.call(null,p1__10132_SHARP_))
{return cljs.core.conj.call(null,p1__10132_SHARP_,p2__10133_SHARP_);
} else
{return cljs.core.PersistentHashSet.fromArray([p2__10133_SHARP_,p1__10132_SHARP_], true);
}
}
});
thi.ng.common.data.core.vec_conj2_STAR_ = (function vec_conj2_STAR_(p1__10134_SHARP_,p2__10135_SHARP_){if((p1__10134_SHARP_ == null))
{return p2__10135_SHARP_;
} else
{if(cljs.core.vector_QMARK_.call(null,p1__10134_SHARP_))
{return cljs.core.conj.call(null,p1__10134_SHARP_,p2__10135_SHARP_);
} else
{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__10134_SHARP_,p2__10135_SHARP_], null);
}
}
});
...
interval_set.cljs$lang$applyTo = (function (arglist__10136){
var ivals = cljs.core.seq(arglist__10136);
...
var check_intervals__delegate = function (ivals){var vec__10142 = cljs.core.reduce.call(null,(function (p__10143,v){var vec__10144 = p__10143;var i = cljs.core.nth.call(null,vec__10144,0,null);var c = cljs.core.nth.call(null,vec__10144,1,null);if(cljs.core.sequential_QMARK_.call(null,v))
...
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentVector.EMPTY,cljs.core.PersistentHashSet.EMPTY], null),ivals);var ivals__$1 = cljs.core.nth.call(null,vec__10142,0,null);var const$ = cljs.core.nth.call(null,vec__10142,1,null);return ((function (vec__10142,ivals__$1,const$){
return (function (x){if(cljs.core.truth_(const$.call(null,x)))
{return x;
} else
{return cljs.core.some.call(null,((function (vec__10142,ivals__$1,const$){
return (function (p__10145){var vec__10146 = p__10145;var a = cljs.core.nth.call(null,vec__10146,0,null);var b = cljs.core.nth.call(null,vec__10146,1,null);return ((a <= x)) && ((x <= b));
});})(vec__10142,ivals__$1,const$))
,ivals__$1);
}
});
;})(vec__10142,ivals__$1,const$))
...
check_intervals.cljs$lang$applyTo = (function (arglist__10147){
var ivals = cljs.core.seq(arglist__10147);
...
{{
var G__10148 = (i - 1);
var G__10149 = cljs.core.assoc.call(null,v_seqs__$2,i,v_original_seqs.call(null,i));
i = G__10148;
v_seqs__$2 = G__10149;
continue;
}
...
cartesian_product.cljs$lang$applyTo = (function (arglist__10150){
var seqs = cljs.core.seq(arglist__10150);
...
var bisect = null;
var bisect__2 = (function (f,coll){var vec__10155 = cljs.core.reduce.call(null,(function (p__10156,v){var vec__10157 = p__10156;var m = cljs.core.nth.call(null,vec__10157,0,null);var n = cljs.core.nth.call(null,vec__10157,1,null);if(cljs.core.truth_(f.call(null,v)))
...
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.transient$.call(null,cljs.core.PersistentVector.EMPTY),cljs.core.transient$.call(null,cljs.core.PersistentVector.EMPTY)], null),coll);var m = cljs.core.nth.call(null,vec__10155,0,null);var n = cljs.core.nth.call(null,vec__10155,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.persistent_BANG_.call(null,m),cljs.core.persistent_BANG_.call(null,n)], null);
});
var bisect__3 = (function (f,f2,coll){var vec__10158 = bisect.call(null,f,coll);var m = cljs.core.nth.call(null,vec__10158,0,null);var n = cljs.core.nth.call(null,vec__10158,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [f2.call(null,m),f2.call(null,n)], null);
});
...
apply_to_keys.cljs$lang$applyTo = (function (arglist__10160){
var type = cljs.core.first(arglist__10160);
arglist__10160 = cljs.core.next(arglist__10160);
var keys = cljs.core.first(arglist__10160);
arglist__10160 = cljs.core.next(arglist__10160);
...
{var pairs = cljs.core.map.call(null,(function (p__10163){var vec__10164 = p__10163;var a = cljs.core.nth.call(null,vec__10164,0,null);var b = cljs.core.nth.call(null,vec__10164,1,null);return f2.call(null,a,b);
...
thi.ng.common.data.core.stringify_keys = (function stringify_keys(m){return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__10167){var vec__10168 = p__10167;var k = cljs.core.nth.call(null,vec__10168,0,null);var v = cljs.core.nth.call(null,vec__10168,1,null);var e = vec__10168;if((k instanceof cljs.core.Keyword))
...
return (function (p1__10169_SHARP_){return (0 <= flags.indexOf([cljs.core.str(p1__10169_SHARP_)].join('')));
});})(flags))
,xs);
} else
{return null;
