(defproject thi.ng/geom-types "0.3.0-SNAPSHOT"
  ...
  :cljsbuild {:builds [{:source-paths ["target/classes" "target/test-classes"]
                        :id "simple"
                        :compiler {:output-to "target/geom-types-0.3.0-SNAPSHOT.js"
                                   :optimizations :whitespace
                                   :pretty-print true}}]
              :test-commands {"unit-tests" ["phantomjs" :runner "target/geom-types-0.3.0-SNAPSHOT.js"]}}
