...
g/PCenter
(center
 ([_] (thi.ng.geom.types.Triangle2. (gu/center (vec3) (:points _))))
 ([_ o] (thi.ng.geom.types.Triangle2. (gu/center (g/centroid _) (vec3 o) (:points _)))))
...
;;;;;;;;;;;; This file autogenerated from src/cljx/thi/ng/geom/triangle.cljx
