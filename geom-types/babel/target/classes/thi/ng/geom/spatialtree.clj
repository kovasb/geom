(ns thi.ng.geom.spatialtree
  (:require
   ...
   [thi.ng.common.math.core :refer [*eps* delta=]])
        (:import [thi.ng.geom.types AABB Rect2]))
...
(deftype MutableOctreeNode
    ...
    (toString [_] (str "#thi.ng.geom.spatialtree.MutableOctreeNode"
      ...
      (defmethod print-method MutableQuadtreeNode [o ^java.io.Writer w] (.write w (.toString o)))
      (defmethod print-method MutableOctreeNode [o ^java.io.Writer w] (.write w (.toString o)))
...
;;;;;;;;;;;; This file autogenerated from src/cljx/thi/ng/geom/spatialtree.cljx
