...
g/PCenter
(center
 ([_] (thi.ng.geom.types.Polygon2. (gu/center (vec3) (:points _))))
 ([_ o] (thi.ng.geom.types.Polygon2. (gu/center (g/centroid _) (vec3 o) (:points _)))))
(centroid
 [{points :points :as _}]
 (let [c (->> points
              (d/rotate-left 1)
...
;;;;;;;;;;;; This file autogenerated from src/cljx/thi/ng/geom/polygon.cljx
