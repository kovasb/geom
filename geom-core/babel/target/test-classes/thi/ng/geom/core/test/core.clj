...
(defn context-vec2-op
  ...
  (testing
    ...
    (if (= cop /)
      (is        (thrown? ArithmeticException (op a2 [s]))
...
(defn context-vec3-op
  ...
  (testing
    ...
    (if (= cop /)
      (is       (thrown?       ArithmeticException (op a3 [bx by]))
...
(deftest vec2-ctor
 ...
 (is (thrown?       IllegalArgumentException                 (vec2 "a")) "fail w/ str arg v2")
...
(deftest vec3-ctor
 ...
 (is (thrown?       IllegalArgumentException                 (vec3 "a")) "fail w/ str arg v3")
...
(deftest swizzle-read
  ...
  (is (= ay (:y a2) (:y a3)) ":y")
  (is (= az (:z a3)) ":z")
  (is (thrown?       IllegalArgumentException                 (:z a2)) ":z fail a2")
  ...
  (is (= [ay ay] (:yy a3)) ":yy")
  (is (= [ay az] (:yz a3)) ":yz")
  (is (thrown?       IllegalArgumentException                 (:xyz a2)) ":xyz fail a2")
  (is (= [ax ay az] (:xyz a3)) ":xyz a3")
  (is (= [az ax ay] (:zxy a3)) ":zxy a3")
  (is (= (a2 0) (a3 0)) "idx 0")
  (is (= (a2 1) (a3 1)) "idx 1")
  (is (= az (a3 2)) "idx 2")
  (is (thrown?       IllegalArgumentException                 (a2 2)) "idx 2 fail a2")
  (is (thrown?       IllegalArgumentException                 (a3 3)) "idx 3 fail a3"))
...
(deftest swizzle-write
  ...
  (is (thrown?       IllegalArgumentException                 (assoc a2 :xz [bx by])) ":xz fail 2d")
  (is (= [by ay bx] (assoc a3 :zx [bx by])) ":zx")
  (is (thrown?       IllegalArgumentException                 (assoc a2 :zx [bx by])) ":zx fail 2d")
  (is (= [ax bx by] (assoc a3 :yz [bx by])) ":yz")
  (is (thrown?       IllegalArgumentException                 (assoc a2 :yz [bx by])) ":yz fail 2d")
  (is (= [ax by bx] (assoc a3 :zy [bx by])) ":zy")
  (is (thrown?       IllegalArgumentException                 (assoc a2 :zy [bx by])) ":zy fail 2d")
  (is (thrown?       IllegalArgumentException                 (assoc a2 :xyz [bx by bz])) ":xyz fail 2d"))
(deftest protocol-impls
  ...
  (is (thrown?       IllegalArgumentException                 (nth a2 2)) "nth a2 fail")
  (is (= az (nth a3 2)) "nth a3")
  (is (= -1 (nth a3 3 -1)) "nth a3 default")
  (is (thrown?       IllegalArgumentException                 (nth a3 3)) "nth a3 fail")
  (is (= ay (peek a2)) "peek a2")
  (is (= az (peek a3)) "peek a3")
  (is (= (pop a2) [ax]) "pop a2")
  (is (= (type (pop a2))       clojure.lang.PersistentVector                                  ) "pop a2 type")
  ...
  (is (thrown?       IllegalArgumentException                 (apply a2 [:z])) "apply a2 fail")
  ...
  (is (thrown?       IllegalArgumentException                 (apply a3 [:w])) "apply a3 fail")
  ...
  (is (=       "[1.0 2.0]"                (str a2)) "toString a2")
  (is (=       "[1.0 2.0 3.0]"                  (str a3)) "toString a3")
  )
